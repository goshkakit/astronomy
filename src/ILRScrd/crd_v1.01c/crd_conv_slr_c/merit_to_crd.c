...
/*  Greetings */
  printf("Convert Merit Fullrate to CRD Format: version 1.01b 02/02/2012\n");
...
/* Session (pass) statistical Record */
  ...
  d50.sess_kurtosis = -1;
  d50.sess_PmM = -1;
  d50.data_qual_ind = -1;	/*hdr.data_qual_ind; */
